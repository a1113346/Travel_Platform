...
curl_setopt_array($curl, [
	CURLOPT_URL => "https://booking-com15.p.rapidapi.com/api/v1/flights/searchFlightsMultiStops?legs=%5B%7B'fromId'%3A'BOM.AIRPORT'%2C'toId'%3A'AMD.AIRPORT'%2C'date'%3A'2024-05-25'%7D%2C%7B'fromId'%3A'AMD.AIRPORT'%2C'toId'%3A'BOM.AIRPORT'%2C'date'%3A'2024-05-28'%7D%5D&pageNo=1&adults=1&children=0%2C17&sort=BEST&cabinClass=ECONOMY&currency_code=AED",
